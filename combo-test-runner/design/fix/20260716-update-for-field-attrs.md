...
- field_attributes was removed in favor of nesting attributes in fields
  - see docs/configuration.md
- the cece config pydantic model is out-of-date. update it
- the test harness needs to adjust to account for the change
- test config will need to change as well
- ensure all combo tests pass